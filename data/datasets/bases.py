...
class BaseDataset(object):
    ...
    def get_imagedata_info1(self, data):
        pids, cams = [], []
...
class BaseImageDataset1(BaseDataset):
    """
    Base class of image reid dataset
    """

    def print_dataset_statistics(self, train, query, gallery):
        num_train_pids, num_train_imgs, num_train_cams = self.get_imagedata_info1(train)
        num_query_pids, num_query_imgs, num_query_cams = self.get_imagedata_info1(query)
        num_gallery_pids, num_gallery_imgs, num_gallery_cams = self.get_imagedata_info1(gallery)
